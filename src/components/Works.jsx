  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        ...
        <h2 className={`${styles.sectionHeadText}`}>Personnelles.</h2>
      </motion.div>
      ...
      <div className="w-full flex">
        ...
        >
          ...
          expérience à travers des exemples concrets de mon travail. Il reflète
          ma capacité à résoudre des problèmes complexes, à travailler avec
          différentes technologies et à gérer des projets de manière efficace.
        </motion.p>
      </div>
